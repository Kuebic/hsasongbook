...
interface ChordProErrorBoundaryProps {
  children?: ReactNode;
...
interface ChordProErrorBoundaryState {
  hasError: boolean;
  error: Error | null;
 ...
 */
class ChordProErrorBoundary extends Component<ChordProErrorBoundaryProps, ChordProErrorBoundaryState> {
  constructor(props: ChordProErrorBoundaryProps) {
    super(props)
    this.state = {
      hasError: false,
      error: null,
  ...
  static getDerivedStateFromError(): Partial<ChordProErrorBoundaryState> {
