 ...
 * @param {Function} props.onUpdate - Callback to trigger the update
 ...
 * @param {boolean} props.persistent - Whether notification stays until action is taken
 * @returns {JSX.Element|null} UpdateNotification component or null
 */
 ...
 * @param {Function} props.onUpdate - Callback to trigger the update
 * @param {Function} props.onDismiss - Callback to dismiss the notification
 * @returns {JSX.Element|null} Compact update notification or null
 */
 ...
 * @param {Object} props - Component props
 * @param {boolean} props.show - Whether to show the progress indicator
 * @param {number} props.progress - Progress percentage (0-100)
 * @returns {JSX.Element|null} Update progress indicator or null
 */
export function UpdateProgress({ show = false, progress = 0 }) {
  if (!show) {
    return null;
  }
 ...
 * @param {Object} props - Component props
 * @param {boolean} props.show - Whether to show the success notification
 * @param {Function} props.onClose - Callback when notification is closed
 * @returns {JSX.Element|null} Update success notification or null
 */
export function UpdateSuccess({ show = false, onClose }) {
  if (!show) {
    return null;
  }
 ...
 * @param {Object} props - Component props
 * @param {boolean} props.show - Whether to show the error notification
 * @param {string} props.error - Error message
 * @param {Function} props.onRetry - Callback to retry the update
 * @param {Function} props.onDismiss - Callback to dismiss the error
 * @returns {JSX.Element|null} Update error notification or null
 */
