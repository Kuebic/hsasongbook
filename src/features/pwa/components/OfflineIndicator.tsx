...
import { useOnlineStatus, useBandwidthAware } from '../hooks/useOnlineStatus';
...
type BadgeVariant = 'destructive' | 'warning' | 'success' | 'default' | 'outline' | 'secondary';
...
export function OfflineIndicator({
  ...
  const getConnectionColor = (): BadgeVariant => {
 ...
 */
export function ConnectionDot({ size = 'md' }: ConnectionDotProps) {
